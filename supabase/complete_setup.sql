...
-- =====================================================
-- الجزء 14: إصلاح البيانات التي لا تحتوي على media_url
-- =====================================================
-- هذا الجزء يصلح أي بيانات موجودة لا تحتوي على media_url
-- (مفيد إذا كانت هناك بيانات قديمة تم إنشاؤها بدون media_url)
...
-- 4. جميع البيانات الآن تحتوي على media_url ✅
